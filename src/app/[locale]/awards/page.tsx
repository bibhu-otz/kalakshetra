        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-text/70 leading-relaxed mb-8">
              We are preparing to showcase the Kalakshetra Samman recipients and 
              their outstanding contributions to Odisha&apos;s cultural heritage. 
              Check back soon for award details and honoree profiles.
            </p>
